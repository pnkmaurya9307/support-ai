        ...
        <div className='min-h-screen bg-zinc-50 text-zinc-900'>
            <div className='sticky top-0 z-40 bg-white border-b border-zinc-200'>
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                    <div className='text-lg font-semibold cursor-pointer' onClick={() => navigate.push("/")}>Lotus Support<span className='text-[#EC4899]'>AI</span></div>
                    ...
                    <div className='mt-14'>
                        ...
                        <div className='rounded-xl border border-zinc-300 bg-white shadow-md overflow-hidden'>
                            ...
                            <div className='relative h-64 sm:h-72 p-6 text-zinc-400 text-sm'>
                                ...
                                <div className='absolute bottom-20 sm:bottom-24 right-3 sm:right-6 left-3 sm:left-auto w-auto sm:w-64 max-w-xs bg-white rounded-xl shadow-xl border border-zinc-200 overflow-hidden'>
                                    ...
                                    <div className='p-3 space-y-2 bg-zinc-50'>
                                        <div className='bg-zinc-200 text-zinc-800 text-xs px-3 py-2 rounded-lg w-fit max-w-[85%]'>hi! how can I help you?</div>
                                        <div className='bg-black text-white text-xs px-3 py-2 rounded-lg ml-auto w-fit max-w-[85%]'>what is the return policy?</div>
                                    </div>
                                </div>
